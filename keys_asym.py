...
def gen_serial_assym_keys(path_public_key: str, path_private_key: str) -> rsa.RSAPublicKey:
    ...
    try:
        ...
        logging.info("gen_serial_assym_keys: success\n")
        return public_key
    except Exception as e:
        logging.error(
            f"gen_serial_assym_keys: there was an error opening the file or generating keys: {str(e)}")
...
def deserial_key_and_dec(path_sym: str, path_private: str) -> bytes:
    ...
    try:
        ...
        logging.info("deserial_key_and_dec: success\n")
        ...
        logging.error(
            f"deserial_key_and_dec: there was an error opening the file: {str(e)}")
        raise Exception("error")
